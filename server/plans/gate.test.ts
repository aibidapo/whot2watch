...
describe('premiumGate', () => {
  ...
  it('passes through when plan enforcement is disabled', async () => {
    ...
    await handler({ headers: { 'x-user-id': 'user-1' }, query: {}, body: {} }, mockReply);
  ...
  it('resolves userId from query param', async () => {
    ...
    await handler({ headers: {}, query: { userId: 'user-1' }, body: {} }, mockReply);
  ...
  it('resolves userId from body', async () => {
    ...
    await handler({ headers: {}, query: {}, body: { userId: 'user-1' } }, mockReply);
